  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(
      ...
      (_, state) => switch (state) {
        UserRegisterStateStus.initial => Nil,
        UserRegisterStateStus.success =>
          Navigator.of(context).pushNamed('/auth/register/barbershop'),
        UserRegisterStateStus.error => Messages.showError('Erro ao registrar usuário Administrador', context)
      },
    );
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => switch (formKey.currentState?.validate()) {
                null || false => Messages.showError('Formulario invalido', context),
